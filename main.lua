...
if (not psuccess) or FAILED then 
	console_print("\127ffffff------------\n\127ff2020WARNING\127ffffff: TCS has \12740ccffNOT\127ffffff loaded correctly.\n\tIf you didn't cause this on purpose, post the following message to the TCS thread in Community Projects or contact 'ARF' on irc.slashnet.org:#vendetta. If you did, go fix it yourself you butt :|")
	printtable(lib_err)
